...
with open('C:/TextminingProject/review_sentiment/review_df_train2.txt', encoding='utf-8') as f:
...
checkpoint_filepath = "./review_sentiment/checkpoints/checkpoint_electra_kr"
